...
const fetchSchedules = shop => dispatch => {
  ...
  return fetch(`http://helloshop-api-jws.azurewebsites.net/api/v1/shops/${shop}/schedules/`, {
    method: 'GET',
    headers: {
...
export const fetchSchedulesIfNeeded = shop => (dispatch, getSate) => {
  if(shouldFetchSchedules(getSate(), shop))
