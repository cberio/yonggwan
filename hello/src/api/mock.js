...
export const DataFieldsSet = {
    ...
    guest: {
        ...
        thumbnail: DataType.IntegerField(),
        is_activated: DataType.IntegerField(),
        created_user_id: DataType.IntegerField(),
        updated_user_id: DataType.IntegerField(),
    }
...
export const DataSet = {
    shop: {
        ...
        leave_dt: null, //max 10|탈퇴일자|YYYY-MM-DD
        leave_memo: null, //max 500|탈퇴사유
    ...
    schedule: {
        ...
        service_code : 'ABCDEFGHIJ', //max 10|상품코드
    ...
    guest: {
        ...
        thumbnail: null, //max 500|썸네일|url
