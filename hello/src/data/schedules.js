const schedule = [
    {
        ...
        reservation_dt: '2017-05-31', // max 10|예약일자|YYYY-MM-DD
        ...
        service_time: '120', // max 50|소요시간|minute
        ...
        start: '2017-05-31T09:00+09:00', // datetime(ISO8601)|서비스시작일시|fullcalendar
        end: '2017-05-31T11:00+09:00', // datetime(ISO8601)|서비스종료일시|fullcalendar
    ...
    },
    {
        ...
        end_time: '14:20',  // max 5|예약 종료 시간|hh:mm
        service_time: '20', // max 50|소요시간|minute
        ...
        created_user_id: 1, // 예약 생성자 user id
        updated_user_id: 1, // 예약 수정자 user id
        start: '2017-05-31T13:00+09:00', // datetime(ISO8601)|서비스시작일시|fullcalendar
        end: '2017-05-31T15:00+09:00', // datetime(ISO8601)|서비스종료일시|fullcalendar
        resourceId: 1, // integer|시술자 고유 id(staff)|fullcalendar
        payments: []
    },
    {
        ...
        service_time: '100', // max 50|소요시간|minute
        ...
        created_user_id: 1, // 예약 생성자 user id
        updated_user_id: 1, // 예약 수정자 user id
        start: '2017-05-31T17:00+09:00', // datetime(ISO8601)|서비스시작일시|fullcalendar
        end: '2017-05-31T19:00+09:00', // datetime(ISO8601)|서비스종료일시|fullcalendar
        resourceId: 1, // integer|시술자 고유 id(staff)|fullcalendar
        payments: [
            {
    ...
    },
    {
        ...
        created_user_id: 1, // 예약 생성자 user id
        updated_user_id: 1, // 예약 수정자 user id
        start: '2017-05-31T15:10+09:00', // datetime(ISO8601)|서비스시작일시|fullcalendar
        end: '2017-05-31T15:30+09:00', // datetime(ISO8601)|서비스종료일시|fullcalendar
        resourceId: 1, // integer|시술자 고유 id(staff)|fullcalendar
        payments: [
            {
    ...
    {
        id: 303030, // integer|예약고유 id
        reservation_dt: '2017-05-31', // max 10|예약일자|YYYY-MM-DD
        shop_id: 1, // integer|shop 고유 id
        staff_id: 1, // integer|시술자 고유 id(staff)
        start_time: '11:30', // max 5|예약 시작 시간|hh:mm
        end_time: '12:30',  // max 5|예약 종료 시간|hh:mm
        service_time: '60', // max 50|소요시간|minute
        guest_id: 10, // integer|예약자 고유 id
        user_id: 10, // integer|예약자 user id
        guest_name: '', // max 100|고객이름
        guest_class: '', // max 10|고객등급
        guest_mobile: '', // 고객휴대번호
        service_code: '', // max 10|상품코드
        shop_service_id: 0, // integer|서비스 고유 id
        status: '100', // max 2|예약상태|00:시술완료,01:예약생성,02:예약요청,03:예약완료,04:변경,05:오프타임,99:취소
        bigo: '', // max 500,nullable|비고
        guest_memo: '', // max 500,nullable|고객메모
        staff_memo: '!', // max 500,nullable|직원메모
        is_delete: 0, // boolean|삭제여부
        created_user_id: 1, // 예약 생성자 user id
        updated_user_id: 1, // 예약 수정자 user id
        start: '2017-05-31T11:30+09:00', // datetime(ISO8601)|서비스시작일시|fullcalendar
        end: '2017-05-31T12:30+09:00', // datetime(ISO8601)|서비스종료일시|fullcalendar
        resourceId: 1, // integer|시술자 고유 id(staff)|fullcalendar
        payments: [
        ]
    }
