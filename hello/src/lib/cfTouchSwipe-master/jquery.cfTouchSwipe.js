...
;(function($, window, document, undefined) {
	...
	function runTouchSwipe(e) {
		...
		switch (swipeDirection) {
			case 'left':
				if (options.swipeLeft && typeof options.swipeLeft === 'function') options.swipeLeft(swipeLength);
				break;

			case 'right':
				if (options.swipeRight && typeof options.swipeRight === 'function') options.swipeRight(swipeLength);
				break;

			case 'down':
				if (options.swipeDown && typeof options.swipeDown === 'function') options.swipeDown(swipeLength);
				break;

			case 'up':
				if (options.swipeUp && typeof options.swipeUp === 'function') options.swipeUp(swipeLength);
				break;
		}
	}
